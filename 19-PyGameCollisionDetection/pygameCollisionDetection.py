...
if __name__ == '__main__':
    ...
    for i in range(20):
        foods.append(
            pygame.Rect(random.randint(0, WINDOW_WIDTH - FOOD_SIZE), random.randint(0, WINDOW_HEIGHT - FOOD_SIZE),
                        FOOD_SIZE, FOOD_SIZE))
    ...
    while True:
        ...
        # Check whether the player has intersected with any food and squares.
        for food in foods[:]:
